...
{{ if (cells.name_4_name.value != "NULL",
"<name" +if(cells.name_4_uri.value != "NULL",
' authority="lcna" valueURI="'+cells.name_4_uri.value + '"', "") +
'><namePart>' + cells.name_4_name.value + '</namePart> ' +
if (cells.name_4_role.value != "NULL" , '<role> <roleTerm authority ="marcrelator" valueURI="http://id.loc.gov/vocabulary/relators/edt.html"> ' + cells.name_4_role.value + '</roleTerm> </role> ', "") + '</name>', "")}}
...
{{ if(cells.subject_name_2_name.value != "NULL", 
"<subject><name " + if (cells.subject_name_2_name.value != "NULL",
 'authority="lcna" valueURI="' + cells.subject_name_2_uri.value + '"', '') 
+ "><namePart>" + cells.subject_name_2_name.value 
+ '</namePart></name></subject>', '')}}

{{ if(cells.subject_name_3_name.value != "NULL", 
"<subject><name " + if (cells.subject_name_3_name.value != "NULL",
 'authority="lcna" valueURI="' + cells.subject_name_3_uri.value + '"', '') 
+ "><namePart>" + cells.subject_name_3_name.value 
+ '</namePart></name></subject>', '')}}

{{ if(cells.subject_name_4_name.value != "NULL", 
"<subject><name " + if (cells.subject_name_4_name.value != "NULL",
 'authority="lcna" valueURI="' + cells.subject_name_4_uri.value + '"', '') 
+ "><namePart>" + cells.subject_name_4_name.value 
+ '</namePart></name></subject>', '')}}
